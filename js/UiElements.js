...
export const forecastDesk = document.querySelector('.forecast-desk');
...
export const buttonForecastSeven = document.querySelector('.forecast-seven');
export const buttonForecastTwoWeeks = document.querySelector('.forecast-two-weeks');
